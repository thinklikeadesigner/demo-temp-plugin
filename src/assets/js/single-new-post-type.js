...
( function () {
	...
	element.innerHTML =
		'demotempplugin/js/single-new-post-type.js, line 10: You are on the single page template for the post type!';
	const firstElement =
	...
	console.log(
		'demotempplugin/js/single-new-post-type.js, line 6: You are on the single page template for the post type!'
	);
} )();
