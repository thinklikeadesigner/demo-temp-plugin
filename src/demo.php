...
<!-- /wp:shortcode -->',
	...
	if ( function_exists( 'update_field' ) ) {
		...
		update_post_meta( $post_id, 'post_field_1', 'This is the value of field 1.' );
		update_post_meta( $post_id, 'post_field_2', 'Option A' );
		update_post_meta( $post_id, 'post_field_3', 'Option B' );
	}
	return $post_id;
}
