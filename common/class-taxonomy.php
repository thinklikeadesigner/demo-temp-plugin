	...
	public function register() {
		...
		if ( ! isset( $this->args['labels'] ) ) {
			$labels                       = array(
				...
				'search_items'      => __( 'Search', 'demotempplugin-textdomain' ) . " {$this->plural}",
				'all_items'         => __( 'All', 'demotempplugin-textdomain' ) . " {$this->plural}",
				'parent_item'       => __( 'Parent', 'demotempplugin-textdomain' ) . " {$this->singular}",
				'parent_item_colon' => __( 'Parent', 'demotempplugin-textdomain' ) . " {$this->singular}:",
				'edit_item'         => __( 'Edit', 'demotempplugin-textdomain' ) . " {$this->singular}",
				'update_item'       => __( 'Update', 'demotempplugin-textdomain' ) . " {$this->singular}",
				'add_new_item'      => __( 'Add New', 'demotempplugin-textdomain' ) . " {$this->singular}",
				/* translators: placeholder is the singular taxonomy name */
				'new_item_name'     => sprintf( esc_html__( 'New %d Name', 'demotempplugin-textdomain' ), $this->singular ),
				...
				<td>
					...
					switch ( $meta['type'] ) {
						...
						case 'link':
							...
							$output = "<input type=\"url\" name=\"term_meta_{$taxonomy}\" id=\"term_meta_{$taxonomy}\" value=\"{$value}\" placeholder=\"https://example.com\" pattern=\"http[s]?://.*\"><p class=\"description\"" . esc_html_e( 'Enter a value for this field', 'demotempplugin-textdomain' ) . '</p>';
							echo wp_kses(
								$output,
								array(
									'input' => array(
						...
						default:
							$value  = $term_meta ? sanitize_text_field( $term_meta ) : '';
							$output = "<input type=\"text\" name=\"term_meta_{$taxonomy}\" id=\"term_meta_{$taxonomy}\" value=\"{$value}\"><p class=\"description\"" . esc_html_e( 'Enter a value for this field', 'demotempplugin-textdomain' ) . '</p>';
							echo wp_kses(
								$output,
								array(
									'input' => array(
