	...
	public function register() {
		...
		if ( ! isset( $this->args['labels'] ) ) {
			$labels                       = array(
				...
				'add_new'            => __( 'Add New', 'demotempplugin-textdomain' ),
				'add_new_item'       => __( 'Add New', 'demotempplugin-textdomain' ) . " {$this->singular}",
				'edit_item'          => __( 'Edit', 'demotempplugin-textdomain' ) . " {$this->singular}",
				'new_item'           => __( 'New', 'demotempplugin-textdomain' ) . " {$this->singular}",
				'view_item'          => __( 'View', 'demotempplugin-textdomain' ) . " {$this->singular}",
				'search_items'       => __( 'Search', 'demotempplugin-textdomain' ) . " {$this->plural}",
				/* translators: placeholder is the plural taxonomy name */
				'not_found'          => sprintf( esc_html__( 'No %s Found', 'demotempplugin-textdomain' ), $this->plural ),
				/* translators: placeholder is the plural taxonomy name */
				'not_found_in_trash' => sprintf( esc_html__( 'No %s found in trash', 'demotempplugin-textdomain' ), $this->plural ),
				'parent_item_colon'  => '',
